...
class Operation(base.MicroInternetGatewayBaseResource):
    ...
    # Properties
    #: ID of micro internet gateway's operation
    id = resource.Body('id')
    #: Target micro internet gateway id of operation.
    resource_id = resource.Body('resource_id')
    #: request type of operation.
    request_type = resource.Body('request_type')
    #: Status of operation.
    status = resource.Body('status')
    #: Reception datetime of operation.
    reception_datetime = resource.Body('reception_datetime')
    #: Commit datetime of operation.
    commit_datetime = resource.Body('commit_datetime')
    #: Request body(JSON String) of operation.
    request_body = resource.Body('request_body')
    #: Warning of operation.
    warning = resource.Body('warning')
    #: Error of operation.
